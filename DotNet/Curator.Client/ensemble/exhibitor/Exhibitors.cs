...
namespace org.apache.curator.ensemble.exhibitor
{
    ...
    public class Exhibitors
    {
        ...
        /// <param name="backupConnectionStringProvider">
        ///     in case an Exhibitor instance can't be contacted, returns the fixed
        ///     connection string to use as a backup
        /// </param>
        public Exhibitors(ICollection<string> hostnames, int restPort,
