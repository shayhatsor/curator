...
namespace org.apache.curator.retry
{
    ...
    public class RetryUntilElapsed : SleepingRetry
    {
        ...
        public RetryUntilElapsed(int maxElapsedTimeMs, int sleepMsBetweenRetries) : base(int.MaxValue)
        {
            this.maxElapsedTimeMs = maxElapsedTimeMs;
            this.sleepMsBetweenRetries = sleepMsBetweenRetries;
        }

        public override bool allowRetry(int retryCount, long elapsedTimeMs, RetrySleeper sleeper)
        {
            return base.allowRetry(retryCount, elapsedTimeMs, sleeper) && (elapsedTimeMs < maxElapsedTimeMs);
        }
