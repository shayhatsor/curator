...
namespace org.apache.curator.utils
{
	...
	public class CloseableScheduledExecutorService : CloseableExecutorService
	{
		...
		public CloseableScheduledExecutorService(ScheduledExecutorService scheduledExecutorService) : base(scheduledExecutorService, false)
		{
		...
		public CloseableScheduledExecutorService(ScheduledExecutorService scheduledExecutorService, bool shutdownOnClose) : base(scheduledExecutorService, shutdownOnClose)
		{
			this.scheduledExecutorService = scheduledExecutorService;
		}
		...
		/// <returns> a Future representing pending completion of
		///         the task and whose <tt>get()</tt> method will return
		///         <tt>null</tt> upon completion </returns>
...
//ORIGINAL LINE: public java.util.concurrent.Future<?> schedule(Runnable task, long delay, java.util.concurrent.TimeUnit unit)
		public virtual Future<?> schedule(Runnable task, long delay, TimeUnit unit)
		{
...
//ORIGINAL LINE: public java.util.concurrent.Future<?> scheduleWithFixedDelay(Runnable task, long initialDelay, long delay, java.util.concurrent.TimeUnit unit)
		public virtual Future<?> scheduleWithFixedDelay(Runnable task, long initialDelay, long delay, TimeUnit unit)
		{
			Preconditions.checkState(isOpen.get(), "CloseableExecutorService is closed");
